...
<div style="background: radial-gradient(circle at 50% 0%, #1c2333 0%, #0d1117 80%); border: 1px solid #30363d; border-radius: 12px; padding: 2rem 1rem; margin: 2rem 0; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.6); display: flex; justify-content: center; overflow-x: auto;">
  <img src="/architecture.svg" alt="System Architecture and Defense Mechanisms" style="max-width: 100%; height: auto;" />
</div>
