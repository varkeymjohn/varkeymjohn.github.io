...
<style>
  ...
  #btn-attack.active, #btn-sample-attack.active {
    color: #ff7b72;
    border-bottom: 2px solid #ff7b72;
  }
  #btn-defense.active, #btn-sample-defense.active {
    color: #3fb950;
    border-bottom: 2px solid #3fb950;
  }

  .tab-content, .sample-tab-content {
    display: none;
    animation: fadeIn 0.4s ease;
  }
  .tab-content.active, .sample-tab-content.active {
    display: block;
  }
