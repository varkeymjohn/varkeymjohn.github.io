...
title: "Aegis-HR: Zero-Trust LLM Evaluation Pipeline"
---

# Aegis-HR: Zero-Trust LLM Evaluation Pipeline

Most AI resume screeners simply pass candidate PDFs to an LLM, making them highly vulnerable to attacks and data leaks. Aegis-HR is a secure, automated screening pipeline designed explicitly to mitigate the **OWASP Top 10 for Large Language Model Applications**.
